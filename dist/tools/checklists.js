...
export function registerChecklistTools(server) {
    // --- Create Checklist ---
    server.registerTool("trello_create_checklist", {
...
Returns:
  Created checklist with id and name.`,
    ...
    // --- Update Checklist ---
    server.registerTool("trello_update_checklist", {
...
Returns:
  Updated checklist confirmation.`,
        ...
        try {
            ...
            const checklist = await client.put(`/checklists/${checklist_id}`, updates);
            return {
                content: [
    ...
    // --- Delete Checklist ---
    server.registerTool("trello_delete_checklist", {
...
Returns:
  Confirmation message.`,
    ...
    // --- Get Checklist ---
    server.registerTool("trello_get_checklist", {
        title: "Get Checklist",
...
Returns:
  Checklist with name and items (showing complete/incomplete status).`,
        ...
        try {
            const client = getTrelloClient();
            const checklist = await client.get(`/checklists/${checklist_id}`, { checkItems: "all" });
            const result = {
                id: checklist.id,
                name: checklist.name,
    ...
    // --- Add Checklist Item ---
    server.registerTool("trello_add_checklist_item", {
...
Returns:
  Created item info.`,
        ...
        try {
            const client = getTrelloClient();
            const item = await client.post(`/checklists/${checklist_id}/checkItems`, {
                name,
                pos: pos !== undefined ? String(pos) : undefined,
    ...
    server.registerTool("trello_update_checklist_item", {
...
Returns:
  Confirmation message.`,
    ...
    server.registerTool("trello_delete_checklist_item", {
...
Returns:
  Confirmation message.`,
        ...
        try {
            const client = getTrelloClient();
            await client.delete(`/checklists/${checklist_id}/checkItems/${check_item_id}`);
            return {
    ...
    // --- Copy Checklist ---
    server.registerTool("trello_copy_checklist", {
